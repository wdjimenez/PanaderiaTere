 ...
 * @author wdjimenez
 */
public class CrearUsuarioView extends javax.swing.JDialog {
...
//        }
    ...
    private void initComponents() {
        ...
        flagAdmin = new javax.swing.JCheckBox();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Validamos que vengan llenos los campos obligatorios
        if(textUsuario.getText().compareTo("") == 0){
        ...
        if(flagAdmin.isSelected())
            admin = 1;
        else
            admin = 0;
        
        
        if(Usuario.createUser(textUsuario.getText(), newPass, salt, textNombre.getText(), textApellidos.getText(), admin)){
            JOptionPane.showMessageDialog(this, "El usuario se genero satisfactoriamente");
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Se presento un problema al generar el usuario");
            return;
        }
...
//    }
    ...
    private javax.swing.JCheckBox flagAdmin;
